...
Prénom : Christophe
Questionnaire : A
IFOSUPWAVRE - examen à blanc – 20/03/2021
****************************************************************
***/
...
LoginID, OrganizationLevel, JobTitle, Birthdate, MaritalStatus, Gender, HireDate
...
IF Object_Id('Tbl_Employee_Engagee_NOM_Christophe') IS NOT NULL
DROP table Tbl_Employee_Engagee_NOM_Christophe

SELECT BusinessEntityID, Title, Firstname, Lastname, NationalIDNumber,
LoginID, OrganizationLevel, JobTitle, Birthdate, MaritalStatus, Gender, CONVERT(NVARCHAR, HireDate, 103) AS Date_embauche 
INTO Tbl_Employee_Engagee_NOM_Christophe
FROM #temp1
GO

SELECT * FROM Tbl_Employee_Engagee_NOM_Christophe
...
------------------------A partir d'ici code non vérifié--------------------------------------------
